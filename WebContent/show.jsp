...
function goPage(){
	...
	alert("我们将去页面show.jsp?flag="+v);
	document.open("show.jsp?flag="+v,"_self","");
}
</script>
<%
...
<div id="wrap">
		<center>
			...
			<br />
			<font class=title>著海学习平台的留言板</font> <a href="list_notes.jsp">返回</a>
			<hr>
			<br>
			<form method="post" action="show.jsp">
			<jsp:useBean id="dao2" class="sh.dao.impl.NoteDaoSQLServerImpl"></jsp:useBean>
			<%
	...
	<form action="show.jsp?flag=first" method="post">
			...
			<jsp:useBean id="dao1" class="sh.dao.impl.PinglunDaoSQLServerImpl" scope="session"></jsp:useBean>
			<%
			request.setCharacterEncoding("UTF-8");
        ...
        <ul class="gitment-comments-list">
    		...
    		<% }%>
    <div id="foot">
    			<a href="show.jsp?flag=<%=SplitPage.FIRSTPAGE%>">首页</a>
    			<a href="show.jsp?flag=<%=SplitPage.PREVIOUSEPAGE%>">上一页</a>
    			<a href="show.jsp?flag=<%=SplitPage.NEXTPAGE%>">下一页</a>
    			<a href="show.jsp?flag=<%=SplitPage.LASTPAGE%>">尾页</a>
    		</div>
